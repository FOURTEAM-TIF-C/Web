        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="font-size: 20px">
                    <strong>SDN SUMBERSARI 02 JEMBER</strong>
                    &nbsp;&nbsp;
                            ...
                            <div class="dropdown-menu dropdown-settings">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">Rezhi Sylvia </h4>
                                        <h5>ADMIN TU</h5>
                                    </div>
                                </div>
                                <hr />   
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="table.html">DATA GURU</a></li>
                            <li><a href="<?php echo base_url()?>Siswa/home">DATA SISWA</a></li>
                             <li><a href="login.html">DATA MAPEL</a></li>
                            <li><a href="blank.html">Laporan Absensi</a></li>
                             <li><a href="blank.html">Nilai & Raport</a></li>
                        </ul>
                    </div>
                </div>
